...
<head>
    ...
    <style>
        ...
        .item{
            ...
            transition: all 0.3s;
            background:white;
            background-image: url("https://picsum.photos/id/46/200/300");
        ...
        .item:hover{
            ...
            transition: all 0.3s;
            z-index:10;
            background-image: url("https://picsum.photos/id/13/200/300");
	        background-position: center;
    ...
    ?>
        ...
        <div style="width:384px;">
         <div class="nav" style="text-align: left;">
             <a href="index_t.php?year=<?=$prev_year;?>&month=<?=$prev;?>">＜＜</a>
         ...
         <div class="nav" style="text-align: right;">
             <a href="index_t.php?year=<?=$next_year;?>&month=<?=$next;?>">＞＞</a>
